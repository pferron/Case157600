    ...
    public class IULLookups
    {
        ...
        internal int ConvertBillType(string billingMethodCode)
        {
            ...
            switch (billingMethodCode?.ToUpper())
            {
                ...
                default:
                    throw new PolicyConverterException($"ConvertBillType failed to process invalid billingMethodCode: {billingMethodCode??"null"} while executing the Index UniversalLife Policy Converter.");
