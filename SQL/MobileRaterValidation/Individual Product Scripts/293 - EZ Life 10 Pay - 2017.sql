...
cross join (
    ...
    from ( values (0, 17), (18, 49), (50, 63), (64, 65), (66, 69), (70, 80)) as InsuredAgeTable(MinInsuredAge, MaxInsuredAge)) vAge
cross join (
...
where
    ((StateGroupId = 105 and MinInsuredAge >= 18 and MaxInsuredAge <=80) 
    or (StateGroupId = 1020 and MinInsuredAge >= 0 and MaxInsuredAge <=80)
    or (StateGroupId = 104 and MinInsuredAge >= 0 and MaxInsuredAge <=80))

and ((StateGroupId = 105 and MinFaceAmount >= 5000 and MaxFaceAmount <= 5000 and MinInsuredAge >= 50 and MaxInsuredAge <= 80)
    or (StateGroupId = 105 and MinFaceAmount >= 10000 and MaxFaceAmount <= 20000 and MinInsuredAge >= 0 and MaxInsuredAge <= 80)

    or (StateGroupId = 1020 and MinFaceAmount >= 5000 and MaxFaceAmount <= 5000 and MinInsuredAge >= 50 and MaxInsuredAge <= 80)
    or (StateGroupId = 1020 and MinFaceAmount >= 10000 and MaxFaceAmount <= 20000 and MinInsuredAge >= 0 and MaxInsuredAge <= 80)

    or (StateGroupId = 104 and MinFaceAmount >= 5000 and MaxFaceAmount <= 5000 and MinInsuredAge >= 50 and MaxInsuredAge <= 69 and MinRatingClass >= 0 and MaxRatingClass <= 0)
    or (StateGroupId = 104 and MinFaceAmount >= 5000 and MaxFaceAmount <= 5000 and MinInsuredAge >= 50 and MaxInsuredAge <= 63 and MinRatingClass >= 1 and MaxRatingClass <= 1)
    or (StateGroupId = 104 and MinFaceAmount >= 10000 and MaxFaceAmount <= 20000 and MinInsuredAge >= 0 and MaxInsuredAge <= 69 and MinRatingClass >= 0 and MaxRatingClass <= 0)
    or (StateGroupId = 104 and MinFaceAmount >= 10000 and MaxFaceAmount <= 20000 and MinInsuredAge >= 0 and MaxInsuredAge <= 63 and MinRatingClass >= 1 and MaxRatingClass <= 1)
    )
