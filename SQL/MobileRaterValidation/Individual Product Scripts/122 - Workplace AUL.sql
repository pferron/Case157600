...
as (
select *
from (select 122 as HeaderCode) vHeader
cross join (
    select StateGroupId
...
cross join (
    ...
    from ( values (-2, -2, 'Super'), (-1, -1, 'Preferred'), (0, 1, 'Standard to Table 1'), (2, 2, 'Table 2'), 
        (3, 3, 'Table 3'), (4, 4, 'Table 4'), (5, 5, 'Table 5'), (6, 6, 'Table 6'), (7, 7, 'Table 7'), (8, 10, 'Table 8 to 10'), 
        (11, 14, 'Table 11 to 14'), (15, 16, 'Table 15 & 16')) 
...
where ((StateGroupId = 1003 and MinInsuredAge >= 16 and MaxInsuredAge <= 85))
