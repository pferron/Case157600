...
SET @HeaderCode = 294
SET @StateGroupId = 1016 -- Non-MT/OR/NY
SET @InsuredAge = 77
SET @IsTobaccoUser = 0
...
cross join (
    select StateGroupId
    from ( values (1021, 'Non-OR/MD/NY'), (104, 'OR'), (105, 'MD')) as StatesTable(StateGroupId, [Description])) vState
cross join (
...
where 
    ...
    or (StateGroupId = 1021 and MinInsuredAge >= 16 and MaxInsuredAge <= 85)
    or (StateGroupId = 104 and MinInsuredAge >= 16 and MaxInsuredAge <= 85))
and	(
       (StateGroupId = 105 and MinFaceAmount >= 5000 and MaxFaceAmount <= 5000 and MinInsuredAge >= 50 and MaxInsuredAge <= 85 and MinRatingClass >= 0 and MaxRatingClass <= 0)
    or (StateGroupId = 105 and MinFaceAmount >= 5000 and MaxFaceAmount <= 5000 and MinInsuredAge >= 50 and MaxInsuredAge <= 80 and MinRatingClass >= 1 and MaxRatingClass <= 1)
    or (StateGroupId = 105 and MinFaceAmount >= 10000 and MaxFaceAmount <= 20000 and MinInsuredAge >= 16 and MaxInsuredAge <= 85 and MinRatingClass >= 0 and MaxRatingClass <= 0)
    or (StateGroupId = 105 and MinFaceAmount >= 10000 and MaxFaceAmount <= 20000 and MinInsuredAge >= 16 and MaxInsuredAge <= 80 and MinRatingClass >= 1 and MaxRatingClass <= 1)

    or (StateGroupId = 1021 and MinFaceAmount >= 5000 and MaxFaceAmount <= 5000 and MinInsuredAge >= 50 and MaxInsuredAge <= 85 and MinRatingClass >= 0 and MaxRatingClass <= 0)
    or (StateGroupId = 1021 and MinFaceAmount >= 5000 and MaxFaceAmount <= 5000 and MinInsuredAge >= 50 and MaxInsuredAge <= 80 and MinRatingClass >= 1 and MaxRatingClass <= 1)
    or (StateGroupId = 1021 and MinFaceAmount >= 10000 and MaxFaceAmount <= 20000 and MinInsuredAge >= 16 and MaxInsuredAge <= 85 and MinRatingClass >= 0 and MaxRatingClass <= 0)
    or (StateGroupId = 1021 and MinFaceAmount >= 10000 and MaxFaceAmount <= 20000 and MinInsuredAge >= 16 and MaxInsuredAge <= 80 and MinRatingClass >= 1 and MaxRatingClass <= 1)
