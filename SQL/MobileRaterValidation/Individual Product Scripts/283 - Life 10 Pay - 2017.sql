...
cross join (
    ...
    from ( values (0, 15), (16, 17), (18, 37), (38, 55), (56, 65), (66, 69), (70, 74), (75, 80)) as InsuredAgeTable(MinInsuredAge, MaxInsuredAge)) vAge
cross join (
...
cross join (
    ...
    from ( values (-2, -2, 'Super'), (-1, -1, 'Preferred'), (0, 1, 'Standard to Table 1'), (2, 3, 'Table 2 & 3'), (4, 4, 'Table 4'), 
        (5, 5, 'Table 5'), (6, 6, 'Table 6'), (7, 7, 'Table 7'), (8, 8, 'Table 8'), (9, 12, 'Table 9 to 12'), 
...
and (MinRatingClass >= -2 and MaxRatingClass <= 
            case 
                ...
                when MinInsuredAge >= 75 and MaxInsuredAge <= 80 then 8
            end)
and (ADRating = 0
