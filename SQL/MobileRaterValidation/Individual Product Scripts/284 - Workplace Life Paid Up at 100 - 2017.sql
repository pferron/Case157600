...
cross join (
    ...
    from ( values (16, 17), (18, 37), (38, 55), (56, 65), (66, 69), (70, 74), (75, 82), (83, 85)) as InsuredAgeTable(MinInsuredAge, MaxInsuredAge)) vAge
cross join (
...
cross join (
    ...
    from ( values (-2, -2, 'Super'), (-1, -1, 'Preferred'), (0, 1, 'Standard to Table 1'), (2, 3, 'Table 2 & 3'), (4, 4, 'Table 4'), 
        (5, 5, 'Table 5'), (6, 6, 'Table 6'), (7, 7, 'Table 7'), (8, 8, 'Table 8'), (9, 12, 'Table 9 to 12'), (13, 16, 'Table 13 to 16')) 
...
and (MinRatingClass >= -2 and MaxRatingClass <= 
            case 
                when MinInsuredAge >= 16 and MaxInsuredAge <= 69  then 16
                when MinInsuredAge >= 70 and MaxInsuredAge <= 74 then 12
                when MinInsuredAge >= 75 and MaxInsuredAge <= 82 then 8
                when MinInsuredAge >= 83 and MaxInsuredAge <= 85 then 6
            end)
and (ADRating = 0
