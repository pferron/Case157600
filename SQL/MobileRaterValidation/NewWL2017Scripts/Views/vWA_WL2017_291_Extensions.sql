Create View WA_WL2017_291_Extensions
as
select *
...
cross join (
    ...
    from ( values (0, 49), (50, 55)) as InsuredAgeTable(MinInsuredAge, MaxInsuredAge)) vAge
cross join (
...
where 
	(--TBD
		MinFaceAmount >= 5000 and MaxFaceAmount <= 5000 and MinInsuredAge >= 50 and MaxInsuredAge <= 55
			or 
		MinFaceAmount >= 10000 and MaxFaceAmount <= 20000 and MinInsuredAge >= 0 and MaxInsuredAge <= 55
    ) and 
