...
/****** Object:  View [dbo].[vCA_NY_WL2017_503_284]    Script Date: 7/12/2018 2:45:20 PM ******/
SET ANSI_NULLS ON
GO
...
Create View [dbo].[vCA_NY_WL2017_503_284]
as (
select *
from (select 284 as HeaderCode) vHeader
cross join (
    select StateGroupId
    from ( values (503, 'CA/NY-WL2017')) as StatesTable(StateGroupId, [Description])) vState
cross join (
    select MinInsuredAge, MaxInsuredAge
    from ( values (16, 17), (18, 37), (38, 55), (56, 64), (65, 65), (66, 69), (70, 74), (75, 79), (80, 82), (83, 85)) as InsuredAgeTable(MinInsuredAge, MaxInsuredAge)) vAge
cross join (
...
cross join (
    ...
    from ( values (-2, -2, 'Super'), (-1, -1, 'Preferred'), (0, 1, 'Standard to Table 1'), (2, 2, 'Table 2'), (3, 3, 'Table 3'), (4, 4, 'Table 4'), 
        (5, 5, 'Table 5'), (6, 6, 'Table 6'), (7, 7, 'Table 7'), (8, 10, 'Table 8 to 10'), (11, 14, 'Table 11 to 14'), (15, 16, 'Table 15 & 16')) 
...
where (((MinFaceAmount >= 100000 and MaxFaceAmount <= 2000000000 and MinInsuredAge >= 18 and MaxInsuredAge <= 85)
...
and (MinRatingClass >= -2 and MaxRatingClass <= 
            case 
                when MinInsuredAge >= 16 and MaxInsuredAge <= 64  then 16
                ...
                when MinInsuredAge >= 80 and MaxInsuredAge <= 82 then 4
                when MinInsuredAge >= 83 and MaxInsuredAge <= 85 then 2
            end)
and (ADRating = 0
...
and (IsAIO = 0
    or (MinInsuredAge >= 16 and MaxInsuredAge <= 37))
)
GO
