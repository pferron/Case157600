...
/****** Object:  View [dbo].[vCA_NY_WL2017_503_280]    Script Date: 7/12/2018 2:42:34 PM ******/
SET ANSI_NULLS ON
GO
...
Create View [dbo].[vCA_NY_WL2017_503_280]
as (
select *
from (select 280 as HeaderCode) vHeader
cross join (
    select StateGroupId
    from ( values (503, 'CA/NY-WL2017')) as StatesTable(StateGroupId, [Description])) vState
cross join (
    select MinInsuredAge, MaxInsuredAge
    from ( values (0, 15), (16, 17), (18, 37), (38, 55), (56, 64), (65, 65), (66, 69), (70, 74), (75, 79), (80, 80), (81, 82), (83, 85)) as InsuredAgeTable(MinInsuredAge, MaxInsuredAge)) vAge
cross join (
...
and ((Gender = 'F' and MinRatingClass >= -2 and MaxRatingClass <= 
            case 
                ...
                when MinInsuredAge >= 81 and MaxInsuredAge <= 85 then 4
            end) 
