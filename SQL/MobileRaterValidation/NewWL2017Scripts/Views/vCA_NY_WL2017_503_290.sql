...
/****** Object:  View [dbo].[vCA_NY_WL2017_503_290]    Script Date: 7/12/2018 2:45:43 PM ******/
SET ANSI_NULLS ON
GO
...
Create View [dbo].[vCA_NY_WL2017_503_290]
as (
select *
...
cross join (
    ...
    from ( values (0, 49), (50, 65), (66, 80), (81, 85)) as InsuredAgeTable(MinInsuredAge, MaxInsuredAge)) vAge
cross join (
