...
/****** Object:  View [dbo].[vCA_NY_WL2017_503_298]    Script Date: 7/12/2018 2:47:53 PM ******/
SET ANSI_NULLS ON
GO
...
Create View [dbo].[vCA_NY_WL2017_503_298]
as (
select *
...
--where 
--	StateGroupId = 1013 and MinInsuredAge >= 50 and MaxInsuredAge <= 80 --TBD
)
GO
