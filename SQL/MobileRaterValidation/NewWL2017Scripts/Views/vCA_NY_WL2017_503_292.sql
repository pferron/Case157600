...
/****** Object:  View [dbo].[vCA_NY_WL2017_503_292]    Script Date: 7/12/2018 2:46:26 PM ******/
SET ANSI_NULLS ON
GO
...
Create View [dbo].[vCA_NY_WL2017_503_292]
as (
select *
...
cross join (
    ...
    from ( values (0, 49), (50, 65), (66, 70)) as InsuredAgeTable(MinInsuredAge, MaxInsuredAge)) vAge
cross join (
...
where 
	(MinFaceAmount >= 5000 and MaxFaceAmount <= 5000 and MinInsuredAge >= 50 and MaxInsuredAge <= 70
		or 
	 MinFaceAmount >= 10000 and MaxFaceAmount <= 20000 and MinInsuredAge >= 0 and MaxInsuredAge <= 70
    ) and 
