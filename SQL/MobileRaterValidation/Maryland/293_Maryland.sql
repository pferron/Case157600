...
cross join (
    select StateGroupId
    from ( values (1020, 'Non-MT/OR/MD'), (104, 'OR'), (105, 'MD')) as StatesTable(StateGroupId, [Description])) vState
cross join (
...
where
	(MinInsuredAge > 17 or StateGroupId <> 105) 
and	((StateGroupId in (1020,105) and MinFaceAmount >= 5000 and MaxFaceAmount <= 5000 and MinInsuredAge >= 50 and MaxInsuredAge <= 80)
    or (StateGroupId in (1020,105) and MinFaceAmount >= 10000 and MaxFaceAmount <= 20000 and MinInsuredAge >= 0 and MaxInsuredAge <= 80)
