...
namespace WOW.Illustration.Model.LPES.Base
{
    ...
    public partial class EmployerSplit
    {
        /// <remarks/>
        [XmlElement(Order = 0)]
        public string SplitLinkKey { get; set; }
        ...
        /// <remarks/>
        [XmlElement(Order = 2)]
        public string SplitIsForGUID { get; set; }

        /// <remarks/>
        [XmlElement("EmployerSplitDetails", Order = 3)]
        public EmployerSplitDetails[] EmployerSplitDetails { get; set; }
    }
}
